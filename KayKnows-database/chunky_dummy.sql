...
;You demonstrates an outstanding level of accomplishment in job performance", "Be a Training Course Sponsor and deliver training in the Discover, Explore and Inspire schools
|Identify and mentor high-potential, junior talent and expedite their personal development
...
;You demonstrates an excellent level of accomplishment in job performance", "Develop talent within your team, ensuring SMARTER stretch and project goals are clearly defined
|Provide anytime performance feedback on Workday to each of your team members at least once a quarter
|Identify training needs for team members and report to the BU talent manager
|Participate, and encourage your people to participate, in recruitment activities
|Actively seek to add talent to Kainos by making hiring and promotion recommendations
|Participate in events/thought leadership initiatives to spread the Kainos name
...
;You demonstrate an avid interest in continuously enhancing current skills and learning new ones", "Be an active career coach and to escalate to their line manager if stretch goals are not set for your coachees
...
;You take decisions independently and are able to get on with your job, escalating decisions only when appropriate", "Mentor junior team members
